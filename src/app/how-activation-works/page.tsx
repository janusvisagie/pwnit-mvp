  ...
  return (
    <main className="mx-auto max-w-3xl space-y-4">
      ...
      <section className="rounded-2xl border border-slate-200 bg-white p-4">
        ...
        <p className="mt-1 text-sm text-slate-700">Play a quick skill game. Each player’s best score stays on the leaderboard. 1st place wins the prize, while 2nd and 3rd place earn credit bonuses. (Practice mode is available anytime, before, after or between paid plays, so you can warm up, learn the controls, or retry without spending credits.)</p>
      </section>
