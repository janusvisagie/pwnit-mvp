    ...
    <html lang="en">
      <body className="min-h-screen overflow-x-hidden bg-slate-50 text-slate-900 md:flex md:h-screen md:flex-col md:overflow-hidden">
        <header className="shrink-0 border-b border-slate-200 bg-white/95 backdrop-blur">
          <div className="mx-auto max-w-[1180px] px-3 py-2 sm:px-4 sm:py-[10px]">
        ...
        <main className="mx-auto w-full max-w-[1180px] flex-1 px-3 py-2 sm:px-4 sm:py-3 md:min-h-0 md:overflow-hidden">
          <div className="w-full md:min-h-0 md:overflow-y-auto">{children}</div>
        </main>

        <footer className="shrink-0 border-t border-slate-200 bg-white">
          <div className="mx-auto max-w-[1180px] px-3 py-2 text-[11px] text-slate-600 sm:px-4 sm:text-xs">
