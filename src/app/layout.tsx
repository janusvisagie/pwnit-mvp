      ...
      <body className="min-h-screen overflow-x-hidden bg-slate-50 text-slate-900 antialiased">
        <div className="flex min-h-screen flex-col">
          <header className="border-b border-slate-200 bg-white/95 backdrop-blur">
            <div className="mx-auto w-full max-w-[1760px] px-3 py-2.5 sm:px-4 sm:py-3 lg:px-6 xl:px-8">
          ...
          <main className="mx-auto w-full max-w-[1760px] flex-1 px-3 py-3 sm:px-4 sm:py-3.5 lg:px-6 xl:px-8">
            {children}
          </main>

          <footer className="border-t border-slate-200 bg-white">
            <div className="mx-auto w-full max-w-[1760px] px-3 py-2 text-[11px] text-slate-600 sm:px-4 sm:text-xs lg:px-6 xl:px-8">
