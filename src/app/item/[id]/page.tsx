        ...
        <div className="grid gap-6 lg:grid-cols-[minmax(0,1.05fr)_minmax(20rem,0.95fr)]">
          ...
          <div className="space-y-4">
            ...
            <div className="grid gap-3 sm:grid-cols-2">
              {isPlayable ? (
                <Link href={`/play/${item.id}`} className="rounded-2xl bg-slate-900 px-4 py-3 text-center text-sm font-bold text-white transition hover:-translate-y-0.5 hover:bg-slate-800">
                  Play now
                </Link>
              ) : (
                <div className="rounded-2xl border border-slate-200 bg-slate-100 px-4 py-3 text-center text-sm font-bold text-slate-500">Not open for play</div>
              )}
              <Link href={`/item/${item.id}/leaderboard`} className="rounded-2xl border border-slate-300 bg-white px-4 py-3 text-center text-sm font-bold text-slate-900 transition hover:-translate-y-0.5">
                Leaderboard
              </Link>
            </div>
            ...
            <div className="rounded-3xl border border-slate-200 bg-white p-4 shadow-sm">
              <div className="text-xs font-semibold uppercase tracking-wide text-slate-500">{product?.kicker ?? "Product details"}</div>
              ...
              {officialUrl ? (
                <a href={officialUrl} target="_blank" rel="noreferrer" className="mt-4 inline-flex rounded-2xl border border-slate-300 bg-white px-4 py-2.5 text-sm font-bold text-slate-900 transition hover:-translate-y-0.5">
