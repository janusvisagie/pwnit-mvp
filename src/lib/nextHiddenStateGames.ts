...
const MOSAIC_TARGETS: Array<{ id: string; label: string; emoji: string; reveals: string[] }> = [
  {
    ...
    label: "Fuel Voucher",
    emoji: "⛽",
    reveals: ["⛽", "🛣️ + ⛽", "A prize that helps on the road", "Used when you refuel your car"],
  },
  {
    id: "checkers-voucher",
    label: "Checkers Voucher",
    emoji: "🛒",
    reveals: ["🛒", "🛒 + 🥛", "A prize for everyday groceries", "Used in a supermarket basket"],
  },
  {
    id: "takealot-voucher",
    label: "Takealot Voucher",
    emoji: "📦",
    reveals: ["📦", "📦 + 🚚", "An online-shopping style prize", "Delivered to your door after checkout"],
  },
  {
    id: "headphones",
    label: "Headphones",
    emoji: "🎧",
    reveals: ["🎧", "🎧 + 🎵", "A prize for private listening", "Worn over your ears for sound"],
  },
  {
    id: "switch",
    label: "Nintendo Switch",
    emoji: "🎮",
    reveals: ["🎮", "🎮 + 🕹️", "A prize built for portable play", "A handheld console with detachable controls"],
  },
  {
    id: "camera",
    label: "GoPro Camera",
    emoji: "📷",
    reveals: ["📷", "📷 + 🌊", "A prize for action footage", "Small camera often used on adventures"],
  },
  {
    id: "bonus-credits",
    label: "Bonus Credits",
    emoji: "⭐",
    reveals: ["⭐", "⭐ + 🎟️", "A prize that keeps you in the game", "Extra tries for another run"],
  },
  {
    id: "podium",
    label: "Podium Place",
    emoji: "🏆",
    reveals: ["🏆", "🏆 + 🥇", "A result worth chasing on PwnIt", "Where the top players finish"],
  },
];
...
const CLUE_LADDER_TARGETS: Array<{ id: string; label: string; emoji: string; clues: string[] }> = [
  {
    ...
    clues: [
      ...
      "People often use it before or during a trip.",
      "It helps with a cost linked to transport.",
      "You redeem it at a filling station.",
    ],
  },
  {
    id: "checkers-voucher",
    ...
    emoji: "🛒",
    clues: [
      "This prize is meant for regular household spending.",
      "It is more about essentials than entertainment.",
      "It fits a trolley better than a gadget bag.",
      "You use it at a grocery retailer.",
    ],
  },
  {
    id: "takealot-voucher",
    ...
    emoji: "📦",
    clues: [
      "This prize works well when you prefer shopping from home.",
      "It points to convenience and delivery.",
      "It is redeemed online rather than in a till queue.",
      "It belongs with one of South Africa’s best-known online stores.",
    ],
  },
  {
    id: "headphones",
    ...
    emoji: "🎧",
    clues: [
      "This prize is worn, not carried in your hand while using it.",
  ...
  },
  {
    ...
    emoji: "📷",
    clues: [
      "This prize is designed for capturing moments, not consuming them.",
      "It is often used in motion or outdoors.",
      "It suits mounting, travel, and action.",
  ...
  },
  {
    ...
    emoji: "⭐",
    clues: [
      "This is a platform reward rather than a physical object.",
      "It gives you more room to keep competing.",
      "It is redeemed inside the game flow itself.",
      "It lets you play more rounds without a prize shipment.",
    ],
  },
  {
    id: "podium",
    ...
    emoji: "🏆",
    clues: [
      "This is a result players chase rather than a product they hold.",
      "It is linked to rank and bragging rights.",
      "It usually means finishing near the very top.",
      "It is where the winners stand.",
    ],
  },
];
